...
public class WraithStrike extends AbstractHealCard {
    ...
    public WraithStrike() {
        super(ID, WraithStrike.class.getSimpleName(),
                cardStrings, 2, ATTACK, CardRarity.UNCOMMON, CardTarget.ALL_ENEMY,null);
	...
	public void update() {
    	super.update();
    	this.action = new WraithStrikeHealAction(this.magicNumber);
    }
