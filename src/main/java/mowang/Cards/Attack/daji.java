...
public class daji extends AbstractExampleCard {
    public static final String ID = ModHelper.MakePath(daji.class.getSimpleName());
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public daji() {
        super(ID, daji.class.getSimpleName(),
