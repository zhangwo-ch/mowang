...
public class shimoPower extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = ModHelper.MakePath(shimoPower.class.getSimpleName());
    // 能力的本地化字段
    ...
    public shimoPower(AbstractCreature owner, int amt) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
